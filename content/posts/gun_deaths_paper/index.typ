...
== Paper overview
In this paper, we analysed data coming from three different datasets: one @Lawprovisions is a collection of all gun restiction laws that have been put in place by individual states, the second @Gundeaths is a collection of gun deaths by county. The third @Violentcrimes trakcs violent crime rates.
...
- From the first dataset, we extracted aggregated data by year and by state regarding deaths and rates of death by guns.
- From the second dataset, we extracted an index to answer the question 'how much regulation around guns is present in this state?'
...
The mean of the violent crimes is 26976.7 per year, with a standard deviation of 34431.64 #footnote([again, this is also not a typo. See previous footnote]), while the mean of the violent crime rate is 6.18%, with a standard deviation of 2.62%
...
= Appendix
The full script and project contents are freely available #link("https://github.com/soliprem/statistics-project", "here") under the GPL_v3 license.
